...
function ActivityListForClub() {
  ...
  useEffect(() => {
    dispatch(getActivitiesByClubId({id:clubId}));
  }, [dispatch]);
...
export default ActivityListForClub;
